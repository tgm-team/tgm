...
train_dg = DGraph(args.dataset, split='train').discretize(args.time_gran)
val_dg = DGraph(args.dataset, split='val').discretize(args.time_gran)
test_dg = DGraph(args.dataset, split='test').discretize(args.time_gran)
