...
train_dg = DGraph(args.dataset, discretize_time_delta=args.time_gran, split='train')
val_dg = DGraph(args.dataset, discretize_time_delta=args.time_gran, split='val')
test_dg = DGraph(args.dataset, discretize_time_delta=args.time_gran, split='test')
