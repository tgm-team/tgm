...
train_loader = DGDataLoader(
    train_dg, batch_size=args.bsize, hook_manager=hm, count_node_labels=False
)
val_loader = DGDataLoader(
    val_dg, batch_size=args.bsize, hook_manager=hm, count_node_labels=False
)
test_loader = DGDataLoader(
    test_dg, batch_size=args.bsize, hook_manager=hm, count_node_labels=False
)
...
for epoch in range(1, args.epochs + 1):
    ...
    if val_ndcg > best_val:
        ...
        log_metric(f'Test {METRIC_TGB_NODEPROPPRED}', test_ndcg, epoch=epoch)
