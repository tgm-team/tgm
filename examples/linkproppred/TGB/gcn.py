...
snapshot_td = TimeDeltaDG(args.shapshot_time_gran, 1)
...
train_snapshots_loader = DGDataLoader(
    train_snapshots,
    hook=[NegativeEdgeSamplerHook(low=0, high=train_dg.num_nodes)],
    batch_unit=args.shapshot_time_gran,
)
...
val_snapshots_loader = DGDataLoader(val_snapshots, batch_unit=args.shapshot_time_gran)
...
test_snapshots_loader = DGDataLoader(test_snapshots, batch_unit=args.shapshot_time_gran)
