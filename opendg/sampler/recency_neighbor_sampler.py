...
class DGRecencyNeighborSampler(DGNeighborSampler):
    r"""In memory neighborhood sampling using exponenital decay with piecewise cutoff sampling probability.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(dg, num_neighbors, sampling_func='decayed', **kwargs)
